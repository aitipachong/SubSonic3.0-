...
{
    public partial class SubSonicTestDB : IQuerySurface
    {
        ...
        public SubSonicTestDB() 
        {
            if (DefaultDataProvider == null) {
                DataProvider = ProviderFactory.GetProvider("procom");
            }
            else {
        ...
        public SubSonicTestDB(string connectionStringName)
        {
            DataProvider = ProviderFactory.GetProvider(connectionStringName);
            Init();
        }

		public SubSonicTestDB(string connectionString, string providerName)
        {
